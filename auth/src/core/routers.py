...
from src.api.v1.user_notification_settings import (
    router as user_notification_settings_router,
)
from src.api.v1.user_subscriptions import router as user_subscriptions_router
...
def register_routers(app: FastAPI) -> None:
    ...
    app.include_router(user_notification_settings_router, prefix=settings.API_V1_PREFIX)
    app.include_router(user_subscriptions_router, prefix=settings.API_V1_PREFIX)
